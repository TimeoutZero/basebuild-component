...
function basebuildMainScript(options){
  ...
  console.log("|_.__/ \__,_|___/\___|_.__/ \__,_|_|_|\__,_|      \___\___/|_| |_| |_| .__/ \___/|_| |_|\___|_| |_|\__|" )
  ...
  for(key in options.modules){
    ...
    if(defaultOptions.modules[key] && value === defaultOptions.modules[key].defaultValue && !bbModule.isExternal){
    ...
    if(!bbModule.notStart && bbModule.isEnabled  !== false){
      let module = require( bbModule.requireName );
